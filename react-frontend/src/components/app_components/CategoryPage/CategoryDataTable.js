...
const pNameTemplate0 = (rowData, { rowIndex }) => <p >{rowData.name}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="name" header="Name" body={pNameTemplate0} filter={selectedFilterFields.includes("name")} hidden={selectedHideFields?.includes("name")}    style={{ minWidth: "8rem" }} />
